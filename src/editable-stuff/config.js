...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/SyedAhmadFazli.png"),
  imageSize: 375,
  message:
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/SyedAhmadFazli.png"), 
...
const getInTouch = {
  ...
  message:
    "xxxxxxxxxx please feel free to email me at",
  email: "edfazli@gmail.com",
};
